...
import 'package:she/features/device/data/repositories/device_repository_impl.dart';

// Project imports:
import 'package:she/features/device/domain/entities/ble_device.dart';
import 'package:she/features/device/presentation/cubit/device_cubit.dart';
...
class _DevicePageState extends State<DevicePage> {
  ...
  List<BleDevice> pairedDevices = [
    BleDevice(name: 'ESP32-IOT', address: '30:AE:A4:07:0D:64', rssi: -45),
  ];
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          DeviceCubit(DeviceRepositoryImpl(BleDataSource()))..init(),
      child: Scaffold(
